...
func registerAllRoutes(r *mux.Router) {
	...
	handleAPI(r, "GET", "/data-sources/local-directory-grants", []string{"document.read"}, datasource.ListLocalDirectoryGrants)
	handleAPI(r, "POST", "/data-sources/local-directory-grants", []string{"document.write"}, datasource.CreateLocalDirectoryGrant)
	handleAPI(r, "DELETE", "/data-sources/local-directory-grants/{grant}", []string{"document.write"}, datasource.DeleteLocalDirectoryGrant)
